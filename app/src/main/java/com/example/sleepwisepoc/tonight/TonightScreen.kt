...
private fun WakeUpCard(state: TonightUiState) {
    ...
    Box(
        modifier = Modifier
            ...
            .background(
                Brush.verticalGradient(
                    colors = listOf(Color(0xFF1A1F3A), NightSurface)
                )
            )
    ) {
        // Subtle purple glow at top-right
        Box(
            modifier = Modifier
                .size(180.dp)
        ...
        Column(modifier = Modifier.padding(24.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    text = "${winStart.format(shortTime())} – ${winEnd.format(shortTime())}",
                    fontSize = 13.sp,
                    fontWeight = FontWeight.SemiBold,
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text(
                    text = "We will wake you during light sleep",
                    fontSize = 13.sp,
                    color = NightTextAccent,
                    fontWeight = FontWeight.Medium,
                )
        ...
        if (ok) {
            Box(
                modifier = Modifier
                    .size(24.dp)
                    .clip(CircleShape)
                    .background(NightSuccess.copy(alpha = 0.15f)),
                contentAlignment = Alignment.Center,
            ) {
                Icon(
    ...
    Box(
        ...
        Row(
            ...
            Icon(
                ...
                contentDescription = null,
                tint = NightTextPrimary,
                modifier = Modifier.size(20.dp),
            )
            Text(
                text = if (isTracking) "Monitoring Active — Tap to Stop" else "Start Sleep Tracking",
                fontSize = 16.sp,
                fontWeight = FontWeight.SemiBold,
                color = NightTextPrimary,
            )
